...
const translations = {
  ...
  navStudentGroups: { en: 'Student Groups', ar: 'الاقسام' },
  ...
  studentGroups: { en: 'Student Groups', ar: 'الاقسام' },
  ...
  allGroups: { en: 'All Groups', ar: 'كل الاقسام' },
  allTeachers: { en: 'All Teachers', ar: 'كل الأساتذة' },
  studentGroup: { en: 'Student Group', ar: 'قسم' },
  ...
  addAtLeastOneSection: { en: 'Add at least one grade/section', ar: 'أضف مستوى/شعبة واحد على الأقل' },
  ...
  // Groups page
  groupsTitle: { en: 'Student Groups', ar: 'الاقسام' },
  groupsSubtitle: { en: 'Manage grades, sections, and their subject allocations.', ar: 'إدارة المستويات و الشعب وتوزيع المواد.' },
  addGroup: { en: 'Add Group', ar: 'إضافة قسم' },
  editGroup: { en: 'Edit Student Group', ar: 'تعديل قسم' },
  allGroupsList: { en: 'All Groups', ar: 'كل الاقسام' },
  className: { en: 'Class', ar: 'الصف' },
  subjectsAndHours: { en: 'Subjects & Hours/Week', ar: 'المواد والساعات/أسبوع' },
  noGroupsYet: { en: 'No groups yet.', ar: 'لا توجد اقسام بعد.' },
  ...
  groupUpdated: { en: 'Group updated', ar: 'تم تحديث القسم' },
  groupAdded: { en: 'Group added', ar: 'تم إضافة القسم' },
  groupDeleted: { en: 'Group deleted', ar: 'تم حذف القسم' },
